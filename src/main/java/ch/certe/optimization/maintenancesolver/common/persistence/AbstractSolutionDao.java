...
package ch.certe.optimization.maintenancesolver.common.persistence;
...
public abstract class AbstractSolutionDao<Solution_> implements SolutionDao<Solution_> {
     ...
     */
    public static final String DATA_DIR_SYSTEM_PROPERTY = "ch.certe.optimization.maintenancesolver.dataDir";
