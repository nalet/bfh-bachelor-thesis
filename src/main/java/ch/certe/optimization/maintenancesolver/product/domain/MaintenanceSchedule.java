...
@XmlRootElement
@PlanningSolution
public class MaintenanceSchedule extends AbstractPersistable {
    ...
    public MaintenanceSchedule(ArrayList<MaintenanceObject> maintenanceObjects, ArrayList<Task> tasks, LocalDate startDate, LocalDate endDate, double accuracy, ArrayList<PlanDate> planDates, HardSoftScore score, long id) {
        super(id);
    ...
    @ValueRangeProvider(id = "PlanDateRange")
