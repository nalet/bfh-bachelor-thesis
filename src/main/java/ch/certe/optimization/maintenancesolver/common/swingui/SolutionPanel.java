...
package ch.certe.optimization.maintenancesolver.common.swingui;
...
public abstract class SolutionPanel<Solution_> extends JPanel implements Scrollable {
    ...
    protected static final String USAGE_EXPLANATION_PATH = "/ch/certe/optimization/maintenancesolver/common/swingui/exampleUsageExplanation.png";
